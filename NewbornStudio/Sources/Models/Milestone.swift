...
struct MilestoneList: Identifiable {
    ...
    static let standard = MilestoneList(
        ...
        milestones: [
            ...
            Milestone(id: "milestone-first-smile", title: "First Smile", group: "Firsts", style: .pink.with(icon: "face.smiling"), aiPrompt: "Change my baby's expression to a joyful gummy smile with eyes gently crinkled, then add a soft golden glow and gentle bokeh sparkles around their face, dreamy studio portrait style."),
            Milestone(id: "milestone-first-laugh", title: "First Laugh", group: "Firsts", style: .pink.with(icon: "sparkles"), aiPrompt: "Change my baby's expression to a big open laugh — eyes crinkled shut, mouth open in delight — then add warm sunbeams and floating golden sparkles around them."),
            Milestone(id: "milestone-first-bath", title: "First Bath", group: "Firsts", style: .mint.with(icon: "drop.fill"), aiPrompt: "Transform into a dreamy bath-time scene: seated in a small vintage-style tub with soft white bubbles, a rubber duck prop nearby, warm diffused light, blush and cream color palette."),
            Milestone(id: "milestone-first-outing", title: "First Outing", group: "Firsts", style: .purple.with(icon: "figure.walk"), aiPrompt: "Add a whimsical sunny park background with soft bokeh and a gentle breeze feel, dressed in a cozy knit sweater as if bundled up for an outing."),
            Milestone(id: "milestone-first-studio-portrait", title: "First Studio Portrait", group: "Firsts", style: .purple.with(icon: "camera.fill"), aiPrompt: "Give this a professional warm studio portrait look — posed on a plush cream faux-fur rug against a soft seamless creamy backdrop, three-point studio lighting with a gentle catchlight in the eyes."),

            Milestone(id: "milestone-holds-head-up", title: "Holds Head Up", group: "Growth & Motor Skills", style: .gold.with(icon: "arrow.up.circle.fill"), aiPrompt: "Change my baby's pose to tummy time, propped up on their little arms with head lifted proudly, then add a soft pastel nursery backdrop with gentle light rays."),
            Milestone(id: "milestone-rolls-over", title: "Rolls Over", group: "Growth & Motor Skills", style: .purple.with(icon: "arrow.triangle.2.circlepath"), aiPrompt: "Change my baby's pose to captured mid-roll from tummy to back, a joyful sense of motion frozen mid-action, on a playful pastel-colored play mat with soft clouds and stars."),
            Milestone(id: "milestone-sits-up-unassisted", title: "Sits Up Unassisted", group: "Growth & Motor Skills", style: .mint.with(icon: "figure.stand"), aiPrompt: "Change my baby's pose to sitting upright fully independently, confident balanced posture, in a cozy soft-cushioned nursery corner."),
            Milestone(id: "milestone-crawls", title: "Crawls", group: "Growth & Motor Skills", style: .gold.with(icon: "tortoise.fill"), aiPrompt: "Change my baby's pose to mid-crawl on all fours with one hand reaching forward, a determined sense of forward motion, on a whimsical adventure-themed pastel trail."),
            Milestone(id: "milestone-pulls-to-stand", title: "Pulls to Stand", group: "Growth & Motor Skills", style: .purple.with(icon: "arrow.up.to.line"), aiPrompt: "Change my baby's pose to standing while holding onto a soft padded ottoman for balance, knees slightly bent in a wobbly but proud stance, warm golden-hour glow behind."),
            Milestone(id: "milestone-first-steps", title: "First Steps", group: "Growth & Motor Skills", style: .gold.with(icon: "flag.checkered"), aiPrompt: "Change my baby's pose to mid-step with one bare foot forward in a wide balancing stance, arms slightly out for balance, on a magical path of soft glowing stepping stones with warm sunset colors."),
            Milestone(id: "milestone-walks-independently", title: "Walks Independently", group: "Growth & Motor Skills", style: .pink.with(icon: "bolt.fill"), aiPrompt: "Change my baby's pose to walking confidently with arms slightly raised for balance and a big proud smile, joyful confetti-filled celebratory background with warm bokeh lights."),

            Milestone(id: "milestone-coos-babbles", title: "Coos & Babbles", group: "Communication", style: .purple.with(icon: "bubble.left.and.bubble.right.fill"), aiPrompt: "Change my baby's expression to mid-coo with an open, expressive little mouth and bright eyes, then add soft floating musical-note illustrations in a dreamy pastel background."),
            Milestone(id: "milestone-says-first-word", title: "Says First Word", group: "Communication", style: .pink.with(icon: "text.bubble.fill"), aiPrompt: "Change my baby's expression to animated and open-mouthed as if mid-word, then add soft pastel speech-bubble sparkle illustrations nearby, warm cozy blurred backdrop."),
            Milestone(id: "milestone-waves-bye-bye", title: "Waves Bye-Bye", group: "Communication", style: .gold.with(icon: "hand.wave.fill"), aiPrompt: "Change my baby's pose so one tiny hand is raised mid-wave near shoulder height, then add a warm golden sunset sky behind them with soft silhouetted clouds and gentle backlighting."),

            Milestone(id: "milestone-first-tooth", title: "First Tooth", group: "Body", style: .pink.with(icon: "checkmark.seal.fill"), aiPrompt: "Change my baby's expression to a gentle open-mouth smile proudly showing a single tiny new tooth, then add a playful soft sparkle accent near the mouth and a cheerful pastel backdrop."),
            Milestone(id: "milestone-first-haircut", title: "First Haircut", group: "Body", style: .mint.with(icon: "scissors"), aiPrompt: "Add a charming little vintage barbershop-style backdrop with soft warm tones, as if seated in a small barber chair."),

            Milestone(id: "milestone-sleeps-through-night", title: "Sleeps Through the Night", group: "Celebrations", style: .purple.with(icon: "moon.zzz.fill"), aiPrompt: "Change my baby's expression to peacefully asleep, eyes gently closed, then add a dreamy starry night sky background with a soft moonlight glow and moonlight-blue bedding."),
            Milestone(id: "milestone-first-holiday-season", title: "First Holiday Season", group: "Celebrations", style: .gold.with(icon: "gift.fill"), aiPrompt: "Add a cozy festive holiday background with warm twinkling lights, dressed in festive-patterned pajamas."),
            Milestone(id: "milestone-first-birthday", title: "First Birthday", group: "Celebrations", style: .gold.with(icon: "star.fill"), aiPrompt: "Change my baby's expression to a big happy smile, then add a joyful birthday party background with soft pastel balloons and confetti.")
        ]
    )
